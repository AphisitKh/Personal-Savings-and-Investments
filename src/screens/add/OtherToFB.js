...
export default function otherToFB(valueE, nameE, typeName, RRN, RR, RT, dayT, dateEndTimestamp, expTime, returnY, totalReturnV, now, noteB){
    dbcon.ref(`asset/${uid}/other/${now}`).set({
