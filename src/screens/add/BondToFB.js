...
export default function bondToFB(valueE, nameE, typeName, RRN, RR, RT, dayT, dateEndTimestamp, expTime, returnY, totalReturnV, now, noteB){
    dbcon.ref(`asset/${uid}/bond/${now}`).set({
