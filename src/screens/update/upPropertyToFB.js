...
export default function upPropertyToFB(valueE, nameE, typeName, RRN, RR, RT, cusA, dayT, dateEndTimestamp, expTime, returnY, totalReturnV, now, noteB){
    dbcon.ref(`asset/${uid}/property/${now}`).update({
