...
export default function upOtherToFB(valueE, nameE, typeName, RRN, RR, RT, dayT, dateEndTimestamp, expTime, returnY, totalReturnV, now, noteB){
    dbcon.ref(`asset/${uid}/other/${now}`).update({
