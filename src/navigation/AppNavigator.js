	...
	return (
		...
		>
			...
			<Tabs.Screen
				...
				options={{
					tabBarLabel: ({ focused }) => (
						<TabBarText focused={focused} title="หน้าหลัก" />
					),
					tabBarIcon: ({ focused }) => (
			...
			<Tabs.Screen
				...
				options={{
					tabBarLabel: ({ focused }) => (
						<TabBarText focused={focused} title="สินทรัพย์" />
					),
					tabBarIcon: ({ focused }) => (
			...
			<Tabs.Screen
				...
				options={{
					tabBarLabel: ({ focused }) => (
						<TabBarText focused={focused} title="รายจ่าย" />
					),
					tabBarIcon: ({ focused }) => (
			...
			<Tabs.Screen
				...
				options={{
					tabBarLabel: ({ focused }) => (
						<TabBarText focused={focused} title="ตั้งค่า" />
					),
					tabBarIcon: ({ focused }) => (
